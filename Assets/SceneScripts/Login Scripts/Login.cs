...
public class Login : MonoBehaviour {
	...
	private void windowFunciton (int windowID) {
        ...
        // TextFields:
        userNameString = GUI.TextField(new Rect(Screen.width / 3, 0.5f * Screen.height / 5f, Screen.width / 3, Screen.height / 10), userNameString, 20, labelStyle);
        userPasswordString = GUI.PasswordField(new Rect(Screen.width / 3, 1.5f * Screen.height / 5, Screen.width / 3, Screen.height / 10), userPasswordString, "*"[0], 10, labelStyle);
        ...
        if (!AppController.appController.getCreatedAccount())
        {
            ...
            userMajorString = GUI.TextField(new Rect(Screen.width / 3, 2.5f * Screen.height / 5f, Screen.width / 3, Screen.height / 10), userMajorString, 50, labelStyle);
